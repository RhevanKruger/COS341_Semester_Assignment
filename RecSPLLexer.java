...
public class RecSPLLexer {
    ...
    private static final String RESERVED_KEYWORDS_REGEX = "(main|begin|end|if|then|else|halt|print|skip|input|output|return|num|text|void|call|add|sub|mul|div|eq|grt|and|or|not|sqrt|=|<|\\(|\\)|\\{|\\}|,|;)";
